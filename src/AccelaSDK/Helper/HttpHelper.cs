...
namespace Accela.WindowsStoreSDK
{
    ...
    public class HttpWebRequestWrapper
    {
        ...
        public override string ToString()
        {
            ...
            strBuilder.AppendLine("RequestUri: " + this._httpWebRequest.RequestUri);
            strBuilder.AppendLine("Accept: " + this._httpWebRequest.Accept);
            strBuilder.AppendLine("ContentType: " + this._httpWebRequest.ContentType);
            strBuilder.AppendLine("Method: " + this._httpWebRequest.Method);
            strBuilder.AppendLine("Headers: " + this._httpWebRequest.Headers.ToString());
    ...
    public class HttpWebResponseWrapper
    {
        ...
        public override string ToString()
        {
            ...
            StringBuilder strBuilder = new StringBuilder();
            strBuilder.AppendLine("ResponseUri: " + this._httpWebResponse.ResponseUri);
            strBuilder.AppendLine("Method: " + this._httpWebResponse.Method);
            strBuilder.AppendLine("StatusCode: " + this._httpWebResponse.StatusCode);
            strBuilder.AppendLine("StatusDescription: " + this._httpWebResponse.StatusDescription);
            strBuilder.AppendLine("ContentType: " + this._httpWebResponse.ContentType);
            strBuilder.AppendLine("Headers: " + this._httpWebResponse.Headers);
