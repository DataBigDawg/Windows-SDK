...
namespace Accela.WindowsPhone8.Sample
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        //private string _a311_recordId = "islandton__TEST__13CAP-00000-000SF";

        //private void btn_CheckSession_Click(object sender, RoutedEventArgs e)
        //{
        //    ProgressRun();
        //    MessageBox.Show(App.A311SDK.IsSessionValid().ToString());
        //    ProgressStop();
        ...
        //        await App.A311SDK.Authorize(_permissions);
        //    }
        //    catch (AccelaOAuthException ex)
        //    {
        //        ShowMessage(ex.Message);
        ...
        //private async void btn_CreateRecord_Click(object sender, RoutedEventArgs e)
        //{
        //    var path = "/v3/a311civicapp/records";
        //    var json = "{\"record\":{\"type\":{\"id\":\"ServiceRequest-Streets and Sidewalks-Snow Removal-NA\"},\"address\":{\"xCoordinate\":\"67.082199\",\"yCoordinate\":\"24.9056\",\"addressFormat\":\"812 9th St, Sacramento, CA, 95814, United States\",\"streetName\":\"812 9th St\",\"city\":\"Sacramento\",\"state\":\"CA\",\"postalCode\":\"95814\"},\"description\":\"Snow Removal at this location.\"}}";
        //    try
        //    {
        //        ProgressRun();

        //        var file = await ChoosePhotoSource();
        //        var files = new List<AccelaMediaStream>() { file };
        //        var result = await App.A311SDK.PostAsync(path, json, files);
        //        _a311_recordId = (result["recordId"] as JsonObject)["id"].ToString();
        //        ShowMessage(result.ToString());
        //    }
        //    catch (Exception ex)
        //    {
        ...
        //private async void btn_AddUserComment_Click(object sender, RoutedEventArgs e)
        //{
        //    var path = "/v3/a311civicapp/records/" + _a311_recordId + "/usercomments";
        //    var json = "{\"comment\": \"sample string 1\"}";
        //    try
        //    {
        //        ProgressRun();

        //        var result = await App.A311SDK.PostAsync(path, json);
        //        ShowMessage(result.ToString());
        ...
        //private async void btn_FollowRecord_Click(object sender, RoutedEventArgs e)
        //{
        //    var path = "/v3/a311civicapp/records/" + _a311_recordId + "/follow";
        //    try
        //    {
        //        ProgressRun();

        //        var result = await App.A311SDK.PostAsync(path);
        //        ShowMessage(result.ToString());
        //    }
        //    catch (Exception ex)
        //    {
        ...
        //private async void btn_GetMyRecords_Click(object sender, RoutedEventArgs e)
        //{
        //    var path = "/v3/a311civicapp/records/mine?offset=0&limit=2";
        //    try
        //    {
        //        ProgressRun();

        //        var result = await App.A311SDK.GetAsync(path);
        //        ShowMessage(result.ToString());
        //    }
        //    catch (Exception ex)
        //    {
        ...
        //private async void btn_GetRecordById_Click(object sender, RoutedEventArgs e)
        //{
        //    var path = "/v3/a311civicapp/records/" + _a311_recordId;
        //    try
        //    {
        //        ProgressRun();
        ...
        //private async void btn_GetUserComments_Click(object sender, RoutedEventArgs e)
        //{
        //    var path = "/v3/a311civicapp/records/" + _a311_recordId + "/usercomments";
        //    try
        //    {
        ...
        //private async void btn_SearchRecords_Click(object sender, RoutedEventArgs e)
        //{
        //    var path = "/v3/a311civicapp/search/records?limit=25&offset=0";
        //    var json = "{\"filter\":{\"geoCircle\":{\"centerY\":\"37.766256\",\"centerX\":\"-121.958127\",\"radius\":\"160900\"}}}";
        //    try
        //    {
        //        ProgressRun();
        ...
        //private async void btn_UnFollowRecord_Click(object sender, RoutedEventArgs e)
        //{
        //    var path = "/v3/a311civicapp/records/" + _a311_recordId + "/unfollow";
        //    try
        //    {
        //        ProgressRun();
